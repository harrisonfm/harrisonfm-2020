...
<style scoped>
  ...
  .header-menu-top {
    @apply flex flex-col items-end absolute top-full right-0 border-l-2 border-b-2 border-gray-600 z-neg bg-white bg-opacity-95 sm:bg-transparent sm:flex-row sm:static sm:border-0 sm:z-0 sm:items-center;
  }
  .header-menu-item {
